...
public class InsializeUnknownObject {
	private Class clazz;

	public <T extends Object> InsializeUnknownObject(Class<T> clazz) {
		this.clazz = clazz;
	}
	...
	/**
	 * Intailize class using constructor
	 * 
	 * @param args
	 * @return
	 * @throws Exception
	 */
	protected Object instantiate(List<String> args) throws Exception {
		// Load the class.
